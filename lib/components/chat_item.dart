...
// import 'package:fyp_social_app/components/text_time.dart';
...
//                 //       return Conversation(
//                 //         userId: userId!,
//                 //         chatId: chatId!, currentUserId: '', selectedUserId: '',
//                 //       );
//                 //     },
//                 //   ),
//                 // );
    ...
    return StreamBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
        if (snapshot.hasData) {
          ...
          final bool hasScore = snap.data() != null && (snap.data() as Map<String, dynamic>).containsKey('reads');
          Map<String, dynamic> usersReads = hasScore ? snap.get('reads') ?? {} : {};
          int readCount = usersReads[currentUserId] ?? 0;
          int counter = messageCount! - readCount;
          if (counter == 0) {
            return SizedBox();
